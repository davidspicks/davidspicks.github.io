...
if (document.getElementById("release-notes-build-013")) {
	document.getElementById("release-notes-build-013").innerHTML = 
	'<ul>Build 013'
		  +'<li>built with Ubuntu 18.04.1</li>'
		  +'<li>react-select controls for daterange and badge filter</li>'
		  +'<li>jsx code</li>'
		  +'<li>no css</li>'
	+'</ul>';  }
